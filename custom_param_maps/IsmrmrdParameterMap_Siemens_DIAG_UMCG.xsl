...
<xsl:stylesheet version="1.0"
    ...
    <xsl:variable name="echoTrainLength">
        <xsl:value-of select="siemens/MEAS/EchoTrainLength"/>
    </xsl:variable>
    ...
    <xsl:template match="/">
        <ismrmrdHeader xsi:schemaLocation="http://www.ismrm.org/ISMRMRD ismrmrd.xsd"
            ...
            <studyInformation>
                ...
                <studyDescription>rawmri_anonymizer_version=1.2|alBValue=<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[1]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[2]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[3]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[4]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[5]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[6]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[7]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[8]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[9]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[10]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[11]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[12]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[13]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[14]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[15]"/>;<xsl:value-of select="siemens/MEAS/sDiffusion/alBValue[16]"/></studyDescription>
